...
которые были устранены. Так же возникали описки в коде, из-за которых в массивах могли генерироваться
одинаковые числа а не разные. Еще одной ошибкой был неправильный знак сравнения в
пирамидальной сортировке, из-за которого сортировка работала не правильно.
\\
\\
\indentЕще одной ошибкой, наверное самой большое, являлось столь поздное начало 
работы над проектом.
